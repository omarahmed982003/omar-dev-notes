...
- المشروع الصغير يكشف الفجوات أسرع من مشاهدة المحاضرات فقط.
...
<span class="diagram-arrow" aria-hidden="true">→</span>
<div class="diagram-node output"><span>ابدأ بخريطة تعلم واضحة: افهم الفكرة، طبّقها، اختبر فهمك</span></div>
</div>
</div>
