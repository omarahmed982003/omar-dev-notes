			...
			sidebar: [
					...
					items: [
						...
						},
						{
							...
							items: [
								...
								{ label: 'Server وProxy وAPI Gateway', translations: { en: 'Servers, Proxies & API Gateways' }, link: 'programming-basics/08-server-proxy-api-gateway' },
								...
								{ label: 'CDN وWAF والمراقبة', translations: { en: 'CDN, WAF & Observability' }, link: 'programming-basics/17-proxies-cdn-waf-observability' },
							],
						},
					],
				},
				{
					...
					items: [
						...
						{ label: '13. البرمجة التنافسية ومنصات التدريب', translations: { en: '13. Competitive programming platforms' }, link: 'cpp/loops-competitive/02-competitive-programming' },
						{ label: '14. مسائل الشروط والصيغ', translations: { en: '14. Conditions & formula problems' }, link: 'cpp/loops-competitive/03-conditions-codeforces' },
					],
				},
				{
					label: 'PHP',
